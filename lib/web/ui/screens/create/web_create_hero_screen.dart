                  ...
                  children: [
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) => providerHero.setTrueName(value),
                        style: TextStyle(
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) => providerHero.setLastName(value),
                        style: TextStyle(
                          color: const Color(0xff1418FA),
                          fontWeight: FontWeight.bold,
                        ),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) => providerHero.setHeroName(value),
                        style: TextStyle(
                          color: const Color(0xff1418FA),
                          fontWeight: FontWeight.bold,
                        ),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async =>
                            print(providerHero.sendHeroInfoToAPI()),
                        style: ElevatedButton.styleFrom(
                          primary: Colors.yellow,
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(5),
